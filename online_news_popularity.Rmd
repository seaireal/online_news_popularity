...
lmod_subset = regsubsets(lmod_formula, data=df, method="forward", nvmax=43)
...
plot(lmod_subset_summary$bic, xlab = "Subset Size", ylab = "BIC", pch = 20, type = "l",
     main = "BIC")
points(21,lmod_subset_summary$bic[21],col="red",cex=2,pch=20)
plot(lmod_subset_summary$adjr2, xlab = "Subset Size", ylab = "Adjusted R2", pch = 20, type = "l",
     main = "Adjusted R2")
points(36,lmod_subset_summary$adjr2[36],col="red",cex=2,pch=20)
