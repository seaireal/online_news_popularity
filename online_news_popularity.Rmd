...
summary(lmod)
# Constant error: Residuals vs fitted plot
residualPlots(lmod, ask = FALSE, layout = c(1,1))
# Normality
qqnorm(residuals(lmod), main='Normal Q-Q plot, Normal distribution'); qqline(residuals(lmod),col='blue')
# Model mean structure: Partial residuals plot
avPlots(lmod, ask = FALSE, layout = c(1,1))
# Multicollinearity
vif(lm(shares ~ . -ranks, data=df))
...
modlg <- glm(ranks~
                ...
                abs_title_sentiment_polarity, data=df_train, family=binomial)
